...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { font-family: system-ui, sans-serif; line-height: 1.6; color: #333; background: {{ $background_color }}; padding: 3rem 1rem; }
        .c { max-width: 560px; margin: 0 auto; text-align: center; }
        h1 { font-size: 1.75rem; margin-bottom: 0.5rem; }
        .tagline { color: #666; margin-bottom: 2rem; }
        .btns { display: flex; flex-wrap: wrap; gap: 0.5rem; justify-content: center; }
        .btns a { display: inline-block; padding: 0.6rem 1.25rem; background: {{ $primary_color }}; color: #fff; text-decoration: none; border-radius: 6px; font-size: 0.9rem; }
        .btns a:nth-child(2) { background: #6c757d; }
        .btns a:nth-child(3) { background: #198754; }
        .btns a:nth-child(4) { background: #0dcaf0; color: #000; }
        .btns a:nth-child(5) { background: #ffc107; color: #000; }
