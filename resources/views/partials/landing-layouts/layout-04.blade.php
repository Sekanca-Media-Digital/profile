...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero { min-height: 70vh; display: flex; align-items: center; justify-content: center; text-align: center; padding: 2rem; background-color: {{ $background_color }}; }
        .hero .overlay { background: rgba(0,0,0,0.4); color: #fff; padding: 2rem; border-radius: 8px; max-width: 600px; }
        .hero .overlay h1 { font-size: 2rem; margin-bottom: 0.75rem; }
        .hero .overlay p { margin-bottom: 1.5rem; opacity: 0.95; }
        .btns a { display: inline-block; padding: 0.75rem 1.5rem; background: {{ $primary_color }}; color: #fff; text-decoration: none; border-radius: 6px; margin: 0 0.25rem 0.5rem 0; }
